...
```
iqtree -s Analyses/IQ-TREE/My_Concat.fa -Q Analyses/IQ-TREE/partitions.txt -m TESTONLY
```
...
```
iqtree -s Analyses/IQ-TREE/My_Concat.fa -q Analyses/IQ-TREE/partitions.txt -m TESTONLY --prefix edge-linked
```
...
```
iqtree -s Analyses/IQ-TREE/My_Concat.fa -Q Analyses/IQ-TREE/partitions.txt -m TESTONLY -m TESTMERGEONLY --prefix Analyses/IQ-TREE/spp_MergedPartitions -rcluster 10
```
