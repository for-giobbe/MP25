...
used to study evolutionary processes with a myriad of possibilities.
...
In this tutorial we will use a gene encoding a rhabdomeric opsin, possibly one of the primary opsins used in a specific organism’s visual system. 
...
the tree ```iqtree -s data/example_selection/Rhabdomeric1.fasta```
